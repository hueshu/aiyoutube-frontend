...
const Navigation: React.FC = () => {
  ...
  const [showVideoGenDropdown, setShowVideoGenDropdown] = useState(false);
  ...
  const videoGenItems = [
    { path: '/single-video-generator', label: '生成单个视频', icon: Video },
    { path: '/video-prompt', label: '批量图转视频', icon: Video },
  ];
  ...
  const isVideoGenActive = videoGenItems.some(item => location.pathname === item.path);
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2 lg:space-x-6">
            <h1 className="text-xl font-bold text-blue-600 whitespace-nowrap">StoryGo.net</h1>
            <div className="flex space-x-1 lg:space-x-2">
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    to={item.path}
                    className={`flex items-center px-2 lg:px-3 py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${
                      isActive
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden lg:inline">生图</span>
              ...
              <div className="relative">
                <button
                  onClick={() => setShowVideoGenDropdown(!showVideoGenDropdown)}
                  onBlur={() => setTimeout(() => setShowVideoGenDropdown(false), 200)}
                  className={`flex items-center px-2 lg:px-3 py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${
                    isVideoGenActive
                      ? 'bg-blue-100 text-blue-700'
                      : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'
                ...
                >
                  ...
                  <span className="hidden lg:inline">生视频</span>
                  <ChevronDown className="w-3 h-3 ml-1" />
                </button>

                {showVideoGenDropdown && (
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden lg:inline">生成prompt</span>
                  <ChevronDown className="w-3 h-3 ml-1" />
                </button>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden lg:inline">库</span>
                  <ChevronDown className="w-3 h-3 ml-1" />
                </button>
